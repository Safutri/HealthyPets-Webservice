          			...
          			<div class="form-panel">
                           <form class="form-horizontal tasi-form">
                              <div class="form-group has-success">
                                  ...
                                  <div class="col-lg-10">
                                      <label>${resepsionis.id}</label>    
                                  </div>
                              </div> 
                              <div class="form-group has-warning">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess"><strong>Nama Resepsionis</strong></label>
                                  <div class="col-lg-10">
      ...
      <section id="main-content">
          <section class="wrapper">
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                           <form class="form-horizontal tasi-form" action="/daftar-drh" method="post">
          
                           <input name="id" type=hidden value="${resepsionis.id}">
                          
                          <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess"><strong>Nama Klinik</strong></label>
                                  <div class="col-lg-10">
                                   <input class="form-control" name="nama_klinik" type="text" value="${resepsionis.nama_klinik}" readonly> 
                                  </div>
                              </div>
                               ...
                               <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess"><strong>Email Klinik</strong></label>
                                  <div class="col-lg-10">
                                   <input class="form-control" name="email_klinik" type="text" value="${resepsionis.email_klinik}" readonly> 
                                  </div>
                              </div>
                              ...
                              <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess"><strong>No. Izin Praktik</strong></label>
                                  <div class="col-lg-10">
                                      <input class="form-control" name="no_praktik" type="text" required> 
                                  </div>
                              </div>  
