          ...
          <section class="wrapper"><br><br><br>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="/perbarui-drh" method="post">  <!-- /pemilik -->
                             <input name="id" value="${drh.id}" hidden="true">                      
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Klinik</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="nama_klinik" value="${drh.nama_klinik}">
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Email Klinik</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="email_klinik" value="${drh.email_klinik}">
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="nama" value="${drh.nama}">
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Alamat</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="alamat" value="${drh.alamat}">
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Email</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="email" value="${drh.email}" readonly>
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No.Telp</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="telp" value="${drh.telp}">
                              </div>
                          </div>  
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No. Praktik</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="no_praktik" value="${drh.no_praktik}" readonly>
                              </div>
                          </div>  
                          <br><br>
