  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="/home" class="logo"><b>HealthyPets</b></a>
            <!--logo end-->
                      ...
                      <!-- SERVER STATUS PANELS -->
                      	...
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn">
								...
								<div class="row">
									<div class="col-sm-6 col-xs-6 goleft">
										<p><i class="fa fa-heart"></i>200</p>
									</div>
									<div class="col-sm-6 col-xs-6"></div>
	                      		</div>
	                      		<div class="centered">
										<img src="Theme/assets/images/dr.png" width="120">
	                      		</div>
                      		</div>
                      	</div><!-- /col-md-4 -->
						...
						<div class="col-md-4 mb">
							...
							<div class="white-panel pn">
								...
								<p><img src="Theme/assets/img/logo.jpg" class="img-circle" width="80"></p>
								<p><b>HealthyPets</b></p>
								<div class="row">
									<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-4 mb">
							...
							<div class="darkblue-panel pn">
								...
								<p class="mt"><b>1500 Clinic</b><br/>/Month</p>
							</div>
						</div><!-- /col-md-4 -->
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            title: 'Welcome to HealthyPets!',
            // (string | mandatory) the text inside the notification
            text: 'Always have your medical record for client animals care <a href="http://healthypets.co.id" target="_blank" style="color:#ffd777">HealthyPets team</a>.',
            // (string | optional) the image to display on the left
            image: 'Theme/assets/img/logo.jpg',
