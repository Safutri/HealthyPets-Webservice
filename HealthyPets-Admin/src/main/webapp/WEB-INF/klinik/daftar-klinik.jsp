          			...
          			<div class="form-panel">
                           <form class="form-horizontal tasi-form">
                              ...
                              <div class="form-group has-warning">
                                  ...
                                  <div class="col-lg-10">
                                    <label>${pemilik.telp}</label>
                                  </div>
                                  <ul class="nav pull-left top-menu"> 
                                   <li><a class="logout" href="/lihat-pemilik-klinik?id=${pemilik.id}">Klinik Terdaftar</a></li>
					               </ul>
                              </div>  
                        </form>
          			</div><!-- /form-panel -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                           <form class="form-horizontal tasi-form" action="/klinik" method="post">
                           <input name="id" type=hidden value="${pemilik.id}">
                              <div class="form-group has-success">
                                  ...
                                  <div class="col-lg-10">
                                   <input class="form-control" name="identitas" type="text" required> 
                                  </div>
                              </div>
                              <div class="form-group has-success">
                              ...
                              <button type="submit" class="btn btn-theme">Daftar Klinik</button> 
                             </form>
          			</div><!-- /form-panel -->
          		</div>
          	</div>        		 
