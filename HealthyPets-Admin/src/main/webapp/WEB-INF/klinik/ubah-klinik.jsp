          ...
          <section class="wrapper"><br><br><br>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="/perbarui-klinik" method="post">  <!-- /pemilik -->
                          <input name="id" value="${klinik.id}" hidden="true">
                         <div class="form-group">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No.Izin Praktik</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="identitas" value="${klinik.identitas}">
                              </div>
                          </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="email" value="${klinik.email}">
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No.Telp</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="telp" value="${klinik.telp}">
                              </div>
                          </div>  <br><br>
