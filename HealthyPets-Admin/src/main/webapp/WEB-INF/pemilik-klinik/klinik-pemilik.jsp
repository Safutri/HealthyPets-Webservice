               ...
               <li class="centered">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                       ...
                       <ul class="sub">
                          <li><a  href="/pilih">Data Pemilik Klinik</a></li>
                      </ul>
                       <ul class="sub">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3>Data Pemilik Klinik</h3>
           
          	<!-- INPUT MESSAGES -->
          	<div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                           <form class="form-horizontal tasi-form" action="/pemilik" method="post">
                              <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess"><strong>Nama Pemilik Klinik</strong></label>
                                  <div class="col-lg-10">
							 ...
							 <ul class="nav pull-left top-menu">
                                <li><a class="logout" href="/perbarui?id=${pemilik.id}">Perbarui Data Pemilik</a></li>  
					         </ul>                               </div> 
                             </form>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3>Daftar Klinik Pemilik</h3>
           
          	<!-- INPUT MESSAGES -->
          	<c:forEach var="klinik" items="${daftarKlinik}">
          	<div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                              ...
                              <div class="form-group has-warning">
                               ...
                               <div class="form-group has-warning">
                                  ...
                                  <div class="col-lg-10">
                                   ...
                                   <ul class="nav pull-left top-menu">
                                   <li><a class="logout" href="/perbarui-klinik?id=${klinik.id}">Perbarui Data Klinik</a></li>
                                  <li><a class="logout" href="/resepsionis?id=${klinik.id}">Resepsionis Terdaftar</a></li>
                                   <li><a class="logout" href="/daftar-resepsionis?id=${klinik.id}">Tambah Resepsionis</a></li>
					               </ul> 
                              </div> 
                           </form>
          			</div><!-- /form-panel --> 
