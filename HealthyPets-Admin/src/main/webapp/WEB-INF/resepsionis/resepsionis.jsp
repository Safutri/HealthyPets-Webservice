  ...
  <section id="container" >
   ...
   <!--sidebar start-->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3>Resepsionis ${klinik.nama}</h3>
           
          	<!-- INPUT MESSAGES -->
          	<c:forEach var="r" items="${resepsionis}">
          	<div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">          			
                           <form class="form-horizontal tasi-form">
			                              ...
			                              <div class="form-group has-warning">
			                                  ...
			                                  <div class="col-lg-10">
			                                      <label>${r.alamat}</label> 
			                                       ...
			                                       <ul class="nav pull-left top-menu"> 
			                                  	 <li><a class="logout" href="/daftar-drh?id=${r.id}">Tambah Dokter Hewan</a></li>
			                                  	 <li><a class="logout" href="/drh?id=${r.id}">Dokter Hewan Terdaftar</a></li>
								                 <li><a class="logout" href="/perbarui-resepsionis?id=${r.id}">Perbarui Data Resepsionis</a></li>  								              
								               </ul> 
