package com.mobile.healthypets.model.antrian.antrianklien;
...
public class TestAntrianKlien extends BaseTest {
...
//	@Test  
//	public void createAntrianKlien() throws NoSuchAlgorithmException, InvalidKeySpecException {
...
//						 
//							 AntrianKlien antri = new AntrianKlien(nama, Ref.create(hewan), Ref.create(resepsionis),
//									 jenis, ras, umur, gender, ttl, warna, no_reg, ktp, drh_jaga, kode_hewan, );
//							  							 
