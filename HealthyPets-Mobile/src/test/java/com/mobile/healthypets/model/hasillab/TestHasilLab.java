...
public class TestHasilLab extends BaseTest{
	...
	private static final Long idAmb = (long) 1111;
	...
	public void createHewan() throws NoSuchAlgorithmException, InvalidKeySpecException {
		...
		Klinik klinik = new Klinik("klinikA", Ref.create(pemakai), "lamteh",
           ...
           HasilLab hlab = new HasilLab(k_parasit, k_jamur, keadaan_feses, p_interna, protozoa, mikroba,
    			...
    			terapi,"1", Ref.create(hewan), Ref.create(resepsionis), Ref.create(ambulator), tgl, kode_hewan, idAmb);
