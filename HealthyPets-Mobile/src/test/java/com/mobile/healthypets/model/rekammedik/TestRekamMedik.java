...
public class TestRekamMedik extends BaseTest{ 
	...
	public void createHewan() throws NoSuchAlgorithmException, InvalidKeySpecException {
		Pemilik pemilik = new Pemilik("diana", "bna", "diana@bna.com", "1323", "0812124552765");
           ...
           RekamMedik rm = new RekamMedik(tgl, nama_drh, status_awal, terapi, diagnosa, obat,
              kode_hewan, no_reg, lain, Ref.create(amb), idAmb);
